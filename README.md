...
#### Key Contributions
- Designed a GPS-enabled system to provide real-time location tracking of public transport buses.
- Implemented continuous data transmission from GPS modules to a central server.
- Enabled live bus location, ETA estimation, and route visibility via a web/mobile interface.
- Conceptualized admin features for fleet management, delay alerts, and route monitoring.
- Integrated hardware, data processing, and front-end visualization into a unified system.

#### Tech Stack
- **Hardware:** GPS Module, Microcontroller  
- **Backend:** Cloud Database (Conceptual)  
- **Frontend:** Web / Mobile Dashboard  
- **Concepts:** IoT, Real-Time Data, Smart City Systems  

#### Impact
- Reduced commuter waiting time through live tracking.
- Improved operational efficiency for transport administrators.
- Demonstrated practical application of embedded systems in smart infrastructure.

---

### Project 2: Drowsiness Detection Using BioAmp EXG Pill  
**Domain:** Biomedical Signal Processing | Wearable Embedded Systems  
**Role:** Embedded System Developer  

#### Key Contributions
- Built a wearable fatigue-detection system using EOG signals from the BioAmp EXG Pill.
- Processed eye-movement signals via Arduino/Maker Uno to detect blink patterns and eye closure.
- Implemented real-time filtering, thresholding, and fatigue detection logic.
- Triggered alerts (LED) upon detection of drowsiness to improve user safety.
